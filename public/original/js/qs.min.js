    ...
    return function i(a, l, c) {
        ...
        3: [function (e, t, r) {
            ...
            function s(e, t) {
                ...
                if (t.charsetSentinel)
                    for (r = 0; r < a.length; ++r) 0 === a[r].indexOf("utf8=") && ("utf8=%E2%9C%93" === a[r] ? c = "utf-8" : "utf8=%26%2310003%3B" === a[r] && (c = "iso-8859-1"), l = r, r = a.length);
                for (r = 0; r < a.length; ++r)
                    if (r !== l) {
                        var s, f, u = a[r],
                            p = u.indexOf("]="),
                            d = -1 === p ? u.indexOf("=") : p + 1;
                        (f = -1 === d ? (s = t.decoder(u, v.decoder, c, "key"), t.strictNullHandling ? null : "") : (s = t.decoder(u.slice(0, d), v.decoder, c, "key"), m(y(u.slice(d + 1), t), function (e) {
                            return t.decoder(e, v.decoder, c, "value")
                        }))) && t.interpretNumericEntities && "iso-8859-1" === c && (f = f.replace(/&#(\d+);/g, function (e, t) {
                            return String.fromCharCode(parseInt(t, 10))
                        })), -1 < u.indexOf("[]=") && (f = g(f) ? [f] : f), b.call(o, s) ? o[s] = h.combine(o[s], f) : o[s] = f
                    } return o
            }
            ...
            function f(e, t, r, o) {
                if (e) {
                    var n = r.allowDots ? e.replace(/\.([^.[]+)/g, "[$1]") : e,
                        ...
                        c = [];
                    if (l) {
                        if (!r.plainObjects && b.call(Object.prototype, l) && !r.allowPrototypes) return;
                        c.push(l)
                    }
                    for (var s = 0; 0 < r.depth && null !== (a = i.exec(n)) && s < r.depth;) {
                        if (s += 1, !r.plainObjects && b.call(Object.prototype, a[1].slice(1, -1)) && !r.allowPrototypes) return;
                        c.push(a[1])
                    }
                            ...
                            for (var n = o ? t : y(t, r), i = e.length - 1; 0 <= i; --i) {
                                ...
                                if ("[]" === l && r.parseArrays) a = [].concat(n);
                                    ...
                                    var c = "[" === l.charAt(0) && "]" === l.charAt(l.length - 1) ? l.slice(1, -1) : l,
                                        s = parseInt(c, 10);
                                    r.parseArrays || "" !== c ? !isNaN(s) && l !== c && String(s) === c && 0 <= s && r.parseArrays && s <= r.arrayLimit ? (a = [])[s] = n : a[c] = n : a = {
                                        0: n
                                    }
                                }
                                n = a
            ...
            t.exports = function (e, t) {
                var r = function (e) {
                    ...
                    var t = void 0 === e.charset ? v.charset : e.charset;
                    return {
        ...
        4: [function (e, t, r) {
            ...
            function j(e, t, r, o, n, i, a, l, c, s, f, u, p) {
                var d, y = e;
                if ("function" == typeof a ? y = a(t, y) : y instanceof Date ? y = s(y) : "comma" === r && x(y) && (y = y.join(",")), null === y) {
                    if (o) return i && !u ? i(t, N.encoder, p, "key") : t;
                    y = ""
                }
                if ("string" == typeof (d = y) || "number" == typeof d || "boolean" == typeof d || "symbol" == typeof d || "bigint" == typeof d || w.isBuffer(y)) return i ? [f(u ? t : i(t, N.encoder, p, "key")) + "=" + f(i(y, N.encoder, p, "value"))] : [f(t) + "=" + f(String(y))];
                var m, h = [];
                ...
                for (var g = 0; g < m.length; ++g) {
                    var v = m[g];
                    n && null === y[v] || (x(y) ? O(h, j(y[v], "function" == typeof r ? r(t, v) : t, r, o, n, i, a, l, c, s, f, u, p)) : O(h, j(y[v], t + (c ? "." + v : "[" + v + "]"), r, o, n, i, a, l, c, s, f, u, p)))
                }
                return h
            }
            var w = e("./utils"),
            ...
            t.exports = function (e, t) {
                var r, o = e,
                    n = function (e) {
                        ...
                        var o = p.formatters[r],
                            n = N.filter;
                        return "function" != typeof e.filter && !x(e.filter) || (n = e.filter), {
                            addQueryPrefix: "boolean" == typeof e.addQueryPrefix ? e.addQueryPrefix : N.addQueryPrefix,
                            ...
                            encodeValuesOnly: "boolean" == typeof e.encodeValuesOnly ? e.encodeValuesOnly : N.encodeValuesOnly,
                            filter: n,
                            formatter: o,
                            serializeDate: "function" == typeof e.serializeDate ? e.serializeDate : N.serializeDate,
                ...
                i = t && t.arrayFormat in y ? t.arrayFormat : t && "indices" in t ? t.indices ? "indices" : "repeat" : "indices";
                var l = y[i];
                r = r || Object.keys(o), n.sort && r.sort(n.sort);
                for (var c = 0; c < r.length; ++c) {
                    var s = r[c];
                    n.skipNulls && null === o[s] || O(a, j(o[s], s, l, n.strictNullHandling, n.skipNulls, n.encode ? n.encoder : null, n.filter, n.sort, n.allowDots, n.serializeDate, n.formatter, n.encodeValuesOnly, n.charset))
                }
                var f = a.join(n.delimiter),
                    u = !0 === n.addQueryPrefix ? "?" : "";
                return n.charsetSentinel && ("iso-8859-1" === n.charset ? u += "utf8=%26%2310003%3B&" : u += "utf8=%E2%9C%93&"), 0 < f.length ? u + f : ""
            }
        }, {
            "./formats": 1,
            "./utils": 5
            ...
            t.exports = {
                ...
                merge: function o(n, i, a) {
                    ...
                    return f(n) && !f(i) && (e = l(n, a)), f(n) && f(i) ? (i.forEach(function (e, t) {
                        if (c.call(n, t)) {
                            var r = n[t];
                            r && "object" == typeof r && e && "object" == typeof e ? n[t] = o(r, e, a) : n.push(e)
                        } else n[t] = e
